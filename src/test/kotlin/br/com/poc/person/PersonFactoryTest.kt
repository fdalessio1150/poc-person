        ...
        fun createRequestPerson(personId: String?, tenantId: String?, journeyId: String?): Person {
            ...
            return Person(
                ...
                PersonObject(
                    fullName,
                    validation(
                        LocalDateTime.of(2022, Month.JUNE, 24, 22, 0, 10),
                        journeyId,
                        200,
                        true,
                        true,
        ...
        fun createDatabasePerson(personId: String?, tenantId: String?, journeyId: String?): Person {
            ...
            return Person(
                ...
                PersonObject(
                    nationalities,
                    validation(
                        LocalDateTime.of(2021, Month.APRIL, 24, 22, 0, 10),
                        journeyId,
                        200,
                        true,
                        false,
